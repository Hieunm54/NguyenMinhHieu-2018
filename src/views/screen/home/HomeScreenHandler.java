...
public class HomeScreenHandler extends BaseScreenHandler implements Initializable{
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        addMenuItem(3, "All", splitMenuBtnSearch);
    }
    ...
    private void addMenuItem(int position, String text, MenuButton menuButton){
        ...
        splitMenuBtnSearch.setOnAction(e->{
            ...
            homeItems.forEach(me -> {
                ...
                String searchItem = this.searchString.getText().trim();
                if(media.getMedia().getTitle().toLowerCase().contains(searchItem)) {
        ...
        menuItem.setOnAction(e -> {
            ...
            homeItems.forEach(me -> {
                ...
                if(media.getMedia().getTitle().toLowerCase().contains(searchItem)) {
	                ...
	                if (text == "All") filteredItems.add(media);
	                
	                if (text == "DVD" || text == "Book" || text == "CD")
