...
public class InvoiceScreenHandler extends BaseScreenHandler {
	...
	void confirmInvoice(MouseEvent event) throws IOException {
	 ...
	 @FXML
	    void backToShipping(MouseEvent event) throws IOException, SQLException {
		 ShippingScreenHandler shippingScreenHandler = new ShippingScreenHandler(this.stage, Configs.SHIPPING_SCREEN_PATH, this.invoice.getOrder());
